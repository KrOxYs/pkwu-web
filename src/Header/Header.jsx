    ...
    return (
            <div className='headers-main w-auto mx-3 py-5 pb-10'>
                <div className='headers-text lg:w-2/5 py-5'>
                    ...
                    <a href="#" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 mt-10 ml-4">
                        Learn more
